...
class Note
  def self.get_notes
    ...
    hm.add(ZOHOCRMSDK::Notes::NotesOperations::GetNotesHeader.If_modified_since, DateTime.new(2019, 8, 10, 4, 10, 9, '+03:00'))
  ...
  def self.create_notes
    ...
    (0..5).each do |i|
      ...
      parent_record.id = 347706111206005
  ...
  def self.update_notes
    # Get instance of NotesOperations Class
    notes_id = [347706111349005, 3_524_033_000_005_539_004]
    no = ZOHOCRMSDK::Notes::NotesOperations.new
    # List to hold Note instances
    notes = []
    (0..1).each do |i|
  ...
  def self.get_note(note_id)
    ...
    # Get instance of HeaderMap Class
    hm = ZOHOCRMSDK::HeaderMap.new
    # hm.add(Notes::NotesOperations::GetNoteHeader.If_modified_since, DateTime.new(2019, 8, 10, 4, 10, 9, '+03:00'))
