...
class Variable
  ...
  def self.get_variable_for_api_name(variable_name)
    ...
    pm.add(ZOHOCRMSDK::Variables::VariablesOperations::GetVariableForAPINameParam.group, 'General')
